...
<head>
  ...
  <style type="text/css">
    ...
    #loading {  position: absolute;  top: 50%;  width: 98%;  margin-top: -70px  }
    #loading.title {  font-family: "Exo", sans-serif;  font-size: 2em;  color: gray;  text-align: center;  white-space: nowrap;  display: block;  line-height: 17px;  font-weight: 300;  }
    #loading.lol {  background: url(<c:url value="/img/loading.gif"/>) no-repeat center;  display: block height : 120 px  }
    .contract-link, .cancel-link, .isPaused-link {  cursor: pointer;  color: #0000FF;  text-decoration: underline;  }
    .tdceter {  valign: center;  }
    .tdWidth {  width: 20px;  }
  </style>
</head>
<body class="x-body">
