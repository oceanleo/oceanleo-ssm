package com.oceanleo.project.ssm.support.mvc.interceptor;

import com.oceanleo.project.ssm.support.core.exception.BizException;
import com.oceanleo.project.ssm.support.mvc.po.Result;
import com.oceanleo.project.ssm.support.mvc.po.ResultCode;
import com.oceanleo.project.ssm.support.orm.page.PageList;
...
public class ResultInterceptor {
    ...
    @Around("execution(public * com.oceanleo..*.controller.*Controller.*(..)) " +
            "&& @annotation(org.springframework.web.bind.annotation.ResponseBody) " +
            "&& !@annotation(com.oceanleo.project.ssm.support.mvc.annotation.NotUseResult) ")
